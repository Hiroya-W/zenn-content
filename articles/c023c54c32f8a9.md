...
![](https://storage.googleapis.com/zenn-user-upload/7002a2378d1f-20220912.png)
...
僕は、今回のインターンを通して、Python で綺麗なサーバーサイドのコードを書く方法を知る、ということも目標にしていました。
...
この時生成する `pyproject.toml` に、フォーマッタの `black`、`isort`、性的型チェッカの `mypy` の設定をまとめる事もできます。
